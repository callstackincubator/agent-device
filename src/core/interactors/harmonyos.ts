...
export function createHarmonyInteractor(device: DeviceInfo): Interactor {
  return {
    ...
    pinch: async (_scale, _x, _y) => {
      // HarmonyOS pinch gesture not implemented via uitest
      throw new Error('Pinch gesture not supported on HarmonyOS');
    },
    rotateGesture: async (_degrees, _x, _y) => {
      // HarmonyOS rotate gesture not implemented via uitest
      throw new Error('Rotate gesture not supported on HarmonyOS');
    },
    transformGesture: async () => {
      // HarmonyOS transform gesture not implemented via uitest
      throw new Error('Transform gesture not supported on HarmonyOS');
    },
