...
import { isRequestCanceled, getRequestSignal } from '../../daemon/request-cancel.ts';
...
export function resolveRequestSignal(requestId: string | undefined): AbortSignal | undefined {
  return getRequestSignal(requestId);
}
