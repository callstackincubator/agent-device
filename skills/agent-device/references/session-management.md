...
- In iOS sessions, use `open <app>`. `open <url>` supports simulators and devices; on devices `http(s)://` opens Safari when no app is active, and custom schemes require an active app in the session.
