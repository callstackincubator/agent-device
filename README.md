...
- iOS deep link open (`open <url>`) is supported on simulators and devices. On devices, `http(s)://` URLs fall back to Safari automatically; custom scheme URLs require an active app in the session.
