...
For persistent defaults and project-scoped CLI settings, see [Configuration](/agent-device/pr-preview/pr-422/docs/configuration.md).
...
See [Replay & E2E (Experimental)](/agent-device/pr-preview/pr-422/docs/replay-e2e.md) for recording and CI workflow details.
...
See [Batching](/agent-device/pr-preview/pr-422/docs/batching.md) for payload format, response shape, and usage guidelines.
