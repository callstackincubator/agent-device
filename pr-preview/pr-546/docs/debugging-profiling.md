...
- Full command reference: [Commands](/agent-device/pr-preview/pr-546/docs/commands.md)
- Typed client observability APIs: [Typed Client](/agent-device/pr-preview/pr-546/docs/client-api.md)
- Session behavior and lifecycle: [Sessions](/agent-device/pr-preview/pr-546/docs/sessions.md)
