...
Use [AI Agent Setup](/agent-device/pr-preview/pr-496/docs/agent-setup.md) for Cursor, Codex, Claude Code, Windsurf, Cline, Goose, skills, and MCP setup. Use [Commands](/agent-device/pr-preview/pr-496/docs/commands.md) for detailed command groups and platform behavior.
...
- Collect runtime evidence: [Debugging & Profiling](/agent-device/pr-preview/pr-496/docs/debugging-profiling.md)
- Record deterministic flows: [Replay & E2E](/agent-device/pr-preview/pr-496/docs/replay-e2e.md)
