...
> agent-device gives coding agents structured UI access, deterministic interactions, and app-level evidence across mobile, TV, and desktop targets. Use it to inspect real apps, debug broken flows, profile runtime behavior, and turn successful explorations into replayable checks.
