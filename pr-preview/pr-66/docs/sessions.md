...
- `open <app> <url>` in iOS sessions opens deep links in the selected app context.
...
For replay scripts and deterministic E2E guidance, see [Replay & E2E (Experimental)](/agent-device/pr-preview/pr-66/docs/replay-e2e.md).
