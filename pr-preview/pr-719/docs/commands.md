...
For persistent defaults and project-scoped CLI settings, see [Configuration](/agent-device/pr-preview/pr-719/docs/configuration.md).
...
See [Replay & E2E](/agent-device/pr-preview/pr-719/docs/replay-e2e.md) for recording, Maestro compatibility, and CI workflow details.
...
See [Batching](/agent-device/pr-preview/pr-719/docs/batching.md) for payload format, response shape, and usage guidelines.
