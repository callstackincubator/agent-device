...
- Full command reference: [Commands](/agent-device/pr-preview/pr-703/docs/commands.md)
- Typed client observability APIs: [Typed Client](/agent-device/pr-preview/pr-703/docs/client-api.md)
- Session behavior and lifecycle: [Sessions](/agent-device/pr-preview/pr-703/docs/sessions.md)
