...
See [Batching](/agent-device/pr-preview/pr-213/docs/batching.md) for payload format, failure handling, and best practices.
...
For deterministic replay scripts and E2E guidance, see [Replay & E2E (Experimental)](/agent-device/pr-preview/pr-213/docs/replay-e2e.md).
