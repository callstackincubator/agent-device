...
- Full command reference: [Commands](/agent-device/pr-preview/pr-511/docs/commands.md)
- Typed client observability APIs: [Typed Client](/agent-device/pr-preview/pr-511/docs/client-api.md)
- Session behavior and lifecycle: [Sessions](/agent-device/pr-preview/pr-511/docs/sessions.md)
