...
- Full command reference: [Commands](/agent-device/pr-preview/pr-460/docs/commands.md)
- Typed client observability APIs: [Typed Client](/agent-device/pr-preview/pr-460/docs/client-api.md)
- Session behavior and lifecycle: [Sessions](/agent-device/pr-preview/pr-460/docs/sessions.md)
