...
- Full command reference: [Commands](/agent-device/pr-preview/pr-483/docs/commands.md)
- Typed client observability APIs: [Typed Client](/agent-device/pr-preview/pr-483/docs/client-api.md)
- Session behavior and lifecycle: [Sessions](/agent-device/pr-preview/pr-483/docs/sessions.md)
