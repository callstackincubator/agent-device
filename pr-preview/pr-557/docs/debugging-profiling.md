...
- Full command reference: [Commands](/agent-device/pr-preview/pr-557/docs/commands.md)
- Typed client observability APIs: [Typed Client](/agent-device/pr-preview/pr-557/docs/client-api.md)
- Session behavior and lifecycle: [Sessions](/agent-device/pr-preview/pr-557/docs/sessions.md)
