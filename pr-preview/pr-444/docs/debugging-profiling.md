...
- Full command reference: [Commands](/agent-device/pr-preview/pr-444/docs/commands.md)
- Typed client observability APIs: [Typed Client](/agent-device/pr-preview/pr-444/docs/client-api.md)
- Session behavior and lifecycle: [Sessions](/agent-device/pr-preview/pr-444/docs/sessions.md)
