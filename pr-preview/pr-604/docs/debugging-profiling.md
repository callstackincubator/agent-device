...
- Full command reference: [Commands](/agent-device/pr-preview/pr-604/docs/commands.md)
- Typed client observability APIs: [Typed Client](/agent-device/pr-preview/pr-604/docs/client-api.md)
- Session behavior and lifecycle: [Sessions](/agent-device/pr-preview/pr-604/docs/sessions.md)
